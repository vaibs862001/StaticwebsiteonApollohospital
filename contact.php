      ...
      <form class="main_form" method="post" name="detail" onsubmit="return(validate())">
        <div class="row mb-3">
          ...
          <div class="col-12 py-2 wow fadeInUp">
            ...
            <textarea id="message" class="form-control" rows="8" placeholder="Address"></textarea>
          </div>
        </div>
...
function validate()
{
  if(document.detail.fullName.value=="")
    {
  alert("Plese provide your Name!");

  document.detail.fullName.focus();
   return false;
   }
   
     var email = document.detail.emailAddress.value;
  atpos = email.indexOf("@");
  dotpos = email.lastIndexOf(".");
 if (email == "" || atpos < 1 || ( dotpos - atpos < 2 )) 
 {
     alert("Please enter correct email ID")
     document.detail.emailAddress.focus() ;
     return false;
 }
      
    if(document.detail.subject.value=="")
    {
  alert("Plese provide your subject!");
